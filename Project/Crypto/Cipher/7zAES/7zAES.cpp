      ...
      const UINT64 *outSize,ICompressProgressInfo *progress)
{
  ...
  CComPtr<ICompressCoder2> aesEncoder;

  #ifdef CRYPTO_AES
  aesEncoder = new CComObjectNoLock<C_AES256_CBC_Encoder>;
  #else
  RINOK(aesEncoder.CoCreateInstance(CLSID_CCrypto_AES256_Encoder));
  #endif
  ...
  return aesEncoder->Code(inStreams, inSizes, 3, 
      ...
      const UINT64 *outSize,ICompressProgressInfo *progress)
{
  ...
  #ifdef CRYPTO_AES
  aesDecoder = new CComObjectNoLock<C_AES256_CBC_Decoder>;
  #else
  RINOK(aesDecoder.CoCreateInstance(CLSID_CCrypto_AES256_Decoder));
  #endif
